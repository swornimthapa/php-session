  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $ranNum = rand(1,10);
        ...
        if($userguess==$ranNum){
            ...
            <strong>Holy guacamole!</strong> You should try it again
   ...
   ?>
    <form action="./test.php" method="POST">
        <div class="input-group mb-3">
                ...
                <button class="btn btn-outline-secondary" type="submit" id="button-addon2">Guess</button>
        </div>
    </form>
